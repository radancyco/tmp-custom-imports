...
if( $('[data-custom-event="true"]').length ) {
    ...
    $('[data-custom-event="true"]').each(function(){
        ...
        // now on anything with class of js-tb-click-tracking we will listen for a click
        $('.js-tb-click-tracking').on('click', clickTrackingFire);
    });
